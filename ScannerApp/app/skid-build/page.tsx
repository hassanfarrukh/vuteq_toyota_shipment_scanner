            ...
            <>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            <p className="text-sm">
                              <span className="font-bold" style={{ color: item.scannedQty >= item.plannedQty ? '#10B981' : '#253262' }}>
                                {item.scannedQty}
                              </span>
              ...
              <Card>
                <CardHeader className="p-0">
                  ...
                  >
                    <CardTitle className="text-sm">
                      Scanned Items ({scannedItems.length}/{plannedItems.length})
                    </CardTitle>
                  ...
                  <CardContent className="space-y-2">
                    {scannedItems.length === 0 ? (
                      ...
                      scannedItems.map((item, idx) => {
                        // Parse Toyota Kanban to get description
                        const parsedKanban = parseToyotaKanban(item.toyotaKanban);
                        const description = parsedKanban?.description || 'N/A';
                        const quantity = parsedKanban?.quantity || '1';
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          setPlannedItems(plannedItems.map(item => {
                            if (item.partNumber === parsedKanban.partNumber) {
